...
<nav class="black lighten-1">
 ...
 <a class="waves-effect waves-light btn modal-trigger" href="#modal1">SignUp</a>
  ...
  <div class="carousel carousel-slider">
    <a class="carousel-item" href="#one!"><img src="img/img5.jpg"></a>
    <div class="carousel-fixed-item center">
    <h2 class="white-text">Heading for the carousel</h2>
    <p class="white-text">the caption/descreption for the carousel</p>
    <a class="waves-effect waves-light btn">More Info <i class="material-icons right">send</i></a>
    </div>
    <a class="carousel-item" href="#two!"><img src="img/img9.jpg"></a>
    <a class="carousel-item" href="#three!"><img src="img/img10.jpg"></a>
    <a class="carousel-item" href="#four!"><img src="img/img12.jpg"></a>
  </div>
...
<section>
	<h2 class="center-align">Our Gallery</h2>
    <div class="row">
    <div class="col s4 m4 l4 offset-l4"><hr></div>
    </div>
    <div class="row">
    <div class="col s12 m4">
    <img src="img/img12.jpg" class="responsive-img materialboxed" data-caption="Awesome picture">
    </div>
    <div class="col s12 m4">
    <img src="img/img14.jpg" class="responsive-img materialboxed" data-caption="Awesome picture">
    </div>
     <div class="col s12 m4">
    <img src="img/img12.jpg" class="responsive-img materialboxed" data-caption="Awesome picture">
    </div>
    ...
    <form class="col s12">
      ...
      <div class="file-path-wrapper">
        <input class="file-path validate" type="text">
         ...
         <a class="btn waves-effect waves-light" type="submit" name="action" onclick="M.toast({html: 'form has been submitted'})">Submit
 ...
 <!-- Modal Structure -->
  <div id="modal1" class="modal">
    <div class="modal-content">
      <h4 class="center-align">Sign Up Form</h4>
      <div class="row">
    <div class="col m6 l6 offset-l3">
    <div class="row">
        <div class="input-field col s6">
      ...
      <div class="row">
       <div class="input-field col s12">
          <input type="text" class="datepicker"><label>DOB</label>
        </div>
        </div>
         <div class="file-field input-field">
      <div class="btn">
